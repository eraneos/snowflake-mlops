...
Duplicated from project-side per ADR-0001 (hub does not import from projects)
and ADR-0003 (each component owns a minimal `core/`). When cross-component
imports become possible (ADR-0020), this is a candidate for centralization.
"""
